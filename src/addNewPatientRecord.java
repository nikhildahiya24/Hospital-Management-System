...
public class addNewPatientRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 40, 250, -1));

        jTextField2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 80, 250, -1));

        jTextField3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, 250, -1));

        jTextField4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 250, -1));

        jComboBox1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Others" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 210, 250, -1));

        jTextField5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 260, 250, -1));

        jTextField6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 300, 250, -1));

        jTextField7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 380, 357, -1));
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 40, 60, -1));

        jTextField8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        getContentPane().add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 40, 94, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("insert into patient values('"+patientID+"', '"+name+"','"+date+"', '"+contactNumber+"', '"+age+"', '"+gender+"', '"+bloodGroup+"', '"+address+"', '"+anyMajorDisease+"')");
...
//            new addNewPatientRecord().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      try{
          PdfWriter.getInstance(doc, new FileOutputStream(path+""+patientID+" "+name+".pdf"));
          doc.open();
         Paragraph paragraph1=new Paragraph("                                           HOSPITAL MANAGEMENT SYSTEM                      Sonipat(HR)\n                                                 A MultiSpeciality Hospital                       C.No:(+91) 9875641889\n\n");
     doc.add(paragraph1);
     Paragraph paragraph6 = new Paragraph("----------------------------------------------------------------------------------------------------------------------------------\n");
      doc.add(paragraph6);
      Paragraph paragraph8 = new Paragraph("             24 HRS. EMERGENCY, PHARMACY, DIAGNOSTIC & AMBULANCE SERVICES\n");
      doc.add(paragraph8);
      Paragraph paragraph7 = new Paragraph("----------------------------------------------------------------------------------------------------------------------------------\n");
      doc.add(paragraph7);
     Paragraph paragraph2=new Paragraph("PATIENTID:   "+patientID+"                                                                                       DATE:   "+date+"\nPATIENT NAME:   "+name+"\nCONTACT NO.:   "+contactNumber+"\nGENDER:   "+gender+"\nAGE:   "+age+"\nBLOOD GROUP:   "+bloodGroup+"\nADDRESS:   "+address+"\nANY MAJOR DISEASE EARLIER?:  "+anyMajorDisease+"\n");
      doc.add(paragraph2);
      Paragraph paragraph3 = new Paragraph("----------------------------------------------------------------------------------------------------------------------------------\n");
      doc.add(paragraph3);
      Paragraph paragraph4 = new Paragraph("PROVISIONAL DIAGNOSIS:\n\n\nPHYSICAL EXAMINATION:\n\n\nALLERGY(IF ANY):\n\n\nINVESTIGATION:\n\n\nTREATMENT:\n\n\nFollowUp/Next Visit:\nNutritional Needs:\nPrecautions:");
      doc.add(paragraph4);
      Paragraph paragraph5 = new Paragraph("\n\n\n\n\n                                                                                                          Doctor's Signature:\n");
      doc.add(paragraph5);
      Paragraph paragraph9 = new Paragraph("----------------------------------------------------------------------------------------------------------------------------------\n");
      doc.add(paragraph9);
      Paragraph paragraph10 = new Paragraph("                                           NOT FOR MEDICO LEGAL PURPOSES");
      doc.add(paragraph10);
     
    
     JOptionPane.showMessageDialog(null,"Prescription Generated");
     setVisible(false);
     new addNewPatientRecord().setVisible(true);
      }
      catch(Exception e)
